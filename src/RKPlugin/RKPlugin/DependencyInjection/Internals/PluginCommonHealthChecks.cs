...
internal static class PluginCommonHealthChecks
{
    static readonly string BaseType = "Microsoft.Extensions.DependencyInjection.CommonHealthChecksExtensions,Microsoft.Extensions.Diagnostics.HealthChecks.Common";
    ...
    public static object? AddTelemetryHealthCheckPublisher(this object? services)
    {
        ...
        var methodInfo = type?.GetMethods().Where(x =>
            x.Name == nameof(AddTelemetryHealthCheckPublisher)
